...
namespace Yelo.Stream
{
    public partial class Main : Form
    {
        ...
        //        if (ks.IsKeyDown(Microsoft.Xna.Framework.Input.Keys.Up)) input.Buttons |= Yelo.Debug.Buttons.Up;
        //        if (ks.IsKeyDown(Microsoft.Xna.Framework.Input.Keys.Down)) input.Buttons |= Yelo.Debug.Buttons.Down;
        //        if (ks.IsKeyDown(Microsoft.Xna.Framework.Input.Keys.Left)) input.Buttons |= Yelo.Debug.Buttons.Left;
        //        if (ks.IsKeyDown(Microsoft.Xna.Framework.Input.Keys.Right)) input.Buttons |= Yelo.Debug.Buttons.Right;
        //        if (ks.IsKeyDown(Microsoft.Xna.Framework.Input.Keys.Z)) input.Buttons |= Yelo.Debug.Buttons.Back;
        //        if (ks.IsKeyDown(Microsoft.Xna.Framework.Input.Keys.X)) input.Buttons |= Yelo.Debug.Buttons.Start;
        //        if (ks.IsKeyDown(Microsoft.Xna.Framework.Input.Keys.Q)) input.Buttons |= Yelo.Debug.Buttons.LeftThumb;
        //        if (ks.IsKeyDown(Microsoft.Xna.Framework.Input.Keys.E)) input.Buttons |= Yelo.Debug.Buttons.RightThumb;

        //        if (ks.IsKeyDown(Microsoft.Xna.Framework.Input.Keys.G)) input.AnalogButtons[(int)Yelo.Debug.AnalogButtons.A] = byte.MaxValue;
        //        if (ks.IsKeyDown(Microsoft.Xna.Framework.Input.Keys.Y)) input.AnalogButtons[(int)Yelo.Debug.AnalogButtons.B] = byte.MaxValue;
        //        if (ks.IsKeyDown(Microsoft.Xna.Framework.Input.Keys.F)) input.AnalogButtons[(int)Yelo.Debug.AnalogButtons.X] = byte.MaxValue;
        //        if (ks.IsKeyDown(Microsoft.Xna.Framework.Input.Keys.T)) input.AnalogButtons[(int)Yelo.Debug.AnalogButtons.Y] = byte.MaxValue;
        //        if (ks.IsKeyDown(Microsoft.Xna.Framework.Input.Keys.C)) input.AnalogButtons[(int)Yelo.Debug.AnalogButtons.White] = byte.MaxValue;
        //        if (ks.IsKeyDown(Microsoft.Xna.Framework.Input.Keys.V)) input.AnalogButtons[(int)Yelo.Debug.AnalogButtons.Black] = byte.MaxValue;
        //        if (ks.IsKeyDown(Microsoft.Xna.Framework.Input.Keys.Space)) input.AnalogButtons[(int)Yelo.Debug.AnalogButtons.LeftTrigger] = byte.MaxValue;
        ...
        //        if (ms.LeftButton == pressed) input.AnalogButtons[(int)Yelo.Debug.AnalogButtons.RightTrigger] = byte.MaxValue;
        ...
        //            if (x360Input.DPad.Up == pressed) input.Buttons |= Yelo.Debug.Buttons.Up;
        //            if (x360Input.DPad.Down == pressed) input.Buttons |= Yelo.Debug.Buttons.Down;
        //            if (x360Input.DPad.Left == pressed) input.Buttons |= Yelo.Debug.Buttons.Left;
        //            if (x360Input.DPad.Right == pressed) input.Buttons |= Yelo.Debug.Buttons.Right;
        //            if (x360Input.Buttons.Back == pressed) input.Buttons |= Yelo.Debug.Buttons.Back;
        //            if (x360Input.Buttons.Start == pressed) input.Buttons |= Yelo.Debug.Buttons.Start;
        //            if (x360Input.Buttons.LeftStick == pressed) input.Buttons |= Yelo.Debug.Buttons.LeftThumb;
        //            if (x360Input.Buttons.RightStick == pressed) input.Buttons |= Yelo.Debug.Buttons.RightThumb;

        //            if (x360Input.Buttons.A == pressed) input.AnalogButtons[(int)Yelo.Debug.AnalogButtons.A] = byte.MaxValue;
        //            if (x360Input.Buttons.B == pressed) input.AnalogButtons[(int)Yelo.Debug.AnalogButtons.B] = byte.MaxValue;
        //            if (x360Input.Buttons.X == pressed) input.AnalogButtons[(int)Yelo.Debug.AnalogButtons.X] = byte.MaxValue;
        //            if (x360Input.Buttons.Y == pressed) input.AnalogButtons[(int)Yelo.Debug.AnalogButtons.Y] = byte.MaxValue;
        //            if (x360Input.Buttons.LeftShoulder == pressed) input.AnalogButtons[(int)Yelo.Debug.AnalogButtons.White] = byte.MaxValue;
        //            if (x360Input.Buttons.LeftShoulder == pressed) input.AnalogButtons[(int)Yelo.Debug.AnalogButtons.Black] = byte.MaxValue;

        //            input.AnalogButtons[(int)Yelo.Debug.AnalogButtons.LeftTrigger] = (byte)(x360Input.Triggers.Left * byte.MaxValue);
        //            input.AnalogButtons[(int)Yelo.Debug.AnalogButtons.RightTrigger] = (byte)(x360Input.Triggers.Right * byte.MaxValue);
