...
namespace Yelo.Debug
{
	public partial class Xbox : IDisposable
	{
		...
		/// <summary>
		/// Keeps track of all the memory Yelo.Debug uses.
		/// </summary>
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		List<AllocationEntry> AllocationTable = new List<AllocationEntry>();

		/// <summary>
		/// Prevents Yelo.Debug from syncing its allocation table with the xbox.
		/// This is usefull if you are confident that you wont lose your connection,
		/// then you can unblock when you wish to manually sync again.  Otherwise, Yelo.Debug 
